	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-timer zmdi-hc-fw"></i><?= $user['tipo']; ?><small> - Padre Registrado</small></h1>
			</div>
        ...
        <!--<table id="customers">-->
          <thead>
            <tr>
              ...
              <?php 
              $records1 = $conn->prepare('SELECT * FROM jugador RIGHT JOIN padre_familia ON jugador.padre_familia_idpadre=padre_familia.idpadre WHERE jugador.usuario=:usuario'); 
              ...
              <tr class="gradeA">
				  ...
				  <td><?php echo $results1['documento']; ?></td>
              </tr>
               <?php 
               } 
               ?>
