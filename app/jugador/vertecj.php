	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-timer zmdi-hc-fw"></i><?= $user['tipo']; ?><small> - Técnico</small></h1>
			</div>
			<p class="lead">Comentario?
        ...
        <!--<table id="customers">-->
          <thead>
            <tr>
              ...
              <?php 
               $records1 = $conn->prepare('SELECT * FROM jugador RIGHT JOIN tecnico ON jugador.tecnico_idtecnico=tecnico.idtecnico WHERE jugador.usuario=:usuario'); 
               $records1->bindParam(':usuario', $_SESSION['user_id']);
               $records1->execute();
              while($results1 = $records1->fetch(PDO::FETCH_ASSOC)) { 
                ?>
              <tr class="gradeA">
                  <td><?php echo $results1['nombres']; ?></td>
				  <td><?php echo $results1['apellidos']; ?></td>
	              <td><img src='../php/<?php print $results1['imagen']; ?>' height="80" width="150"></td>
	              <td><?php echo $results1['telefono']; ?></td>
	              <td><?php echo $results1['tipo']; ?></td>
				  <td><?php echo $results1['direccion']; ?></td>
