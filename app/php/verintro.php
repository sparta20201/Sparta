...
if (!empty($_FILES['imagen'])) {
	if($_FILES['imagen']['type']=="image/jpeg" or $_FILES['imagen']['type']=="image/png" or $_FILES['imagen']['type']=="image/jpg"){
		...
		$nombrefoto = $conn->prepare("SELECT id FROM tblintroduccion ORDER BY id DESC LIMIT 1");
		$nombrefoto->execute();
		...
		$sql = "INSERT INTO tblintroduccion (foto) VALUES (:imagen)";
		$stmt = $conn->prepare($sql);
		/*insertar una imagen al servidor*/
		$stmt->bindParam(':imagen', $ruta);
		$archivo=$_FILES['imagen']['tmp_name'];
		$ruta='inicio/'.$nombreimg;
...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i><?= $user['tipo']; ?><small> - Galería de Fotos Introducción</small></h1>
	</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<?php 
							$records1 = $conn->prepare('SELECT * FROM tblintroduccion');
							$records1->execute();
							...
							<tr class="gradeA">
								...
								<td class="text-center"><a href='../php/eliminar/eliminarIntro.php?id=<?php echo $results1['id']; ?>' class="btn btn-danger btn-raised btn-xs" onclick="return confirm('¿Estas seguro que desea eliminar el registro con Mensaje?\n <?php echo $results1['foto']; ?>');"><i class="zmdi zmdi-delete"></i></a>
								</td>
							</tr>
							<?php 
							} 
