<?php
 ...
 //actualizar datos
	if(isset($_POST['id'])){
        ...
        $records2=$conn->prepare("UPDATE padre_familia SET nombres=:nombres,apellidos=:apellidos,documento=:documento,direccion=:direccion,telefono=:telefono WHERE idpadre=:id");
        ...
        $records2->bindParam(":documento",$documento); 
           
	    if($records2->execute()){
	      $message1 = 'Datos actualizados';
	    }else{
	     $message1 = 'No se pudo actualizar los datos';
	    }
	}			
?>
<!DOCTYPE html>
...
<body onload="startTime()">
	...
	<section class="full-box dashboard-contentPage">
		...
		//Recuperar datos
		  if(isset($_GET['id'])){
		    $id=$_GET['id'];
		    $records = $conn->prepare("SELECT * FROM padre_familia WHERE idpadre=:id");
		...
		<div class="container-fluid">
			...
			<p class="lead">Espacio para actualizar datos de los padres.
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li><a href="verpadre.php">Volver</a></li>
					</ul>
							...
							<div class="container-fluid">
								<div class="row">
								    ...
								    <form action="" method="post" enctype="multipart/form-data">
								    	<input name="id" type="hidden" value="<?php echo $results['idpadre']; ?>" required="">
