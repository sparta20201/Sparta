<?php
 ...
 //actualizar datos
	if(isset($_POST['id'])){
	    ...
	    $peso = $_POST['peso'];
	    $altura = $_POST['altura'];
	    $acudiente = $_POST['padre_familia_idpadre'];
	    $categoria = $_POST['categoria_idcategoria'];
	    $tecnico = $_POST['tecnico_idtecnico'];
								...
								<div class="row">
								    ...
								    <form action="" method="post" enctype="multipart/form-data">
										...
										<div class="form-group label-floating">
										  ...
										  <input name="documento" value="<?php echo $results['tipo_doc']; ?>" class="form-control" type="text" readonly>
										</div>
										<div class="form-group label-floating">
										...
										<div class="form-group label-floating">
											  ...
											  <?php 
									 		  $records1 = $conn->prepare('SELECT * FROM jugador RIGHT JOIN padre_familia ON jugador.padre_familia_idpadre=padre_familia.idpadre');
									 		  $records1->execute();
									        ?>
									        <select name="padre_familia_idpadre" class="form-control" required="">
									          <?php
											...
											<div class="form-group label-floating">
											  ...
											  <?php 
									            $records2= $conn->prepare('SELECT * FROM jugador RIGHT JOIN categoria ON jugador.categoria_idcategoria=categoria.idcategoria');
	 		                                    $records2->execute();
									        ?>
											...
											<div class="form-group label-floating">
											  ...
											  <?php 
											   $records3= $conn->prepare('SELECT * FROM jugador RIGHT JOIN tecnico ON jugador.tecnico_idtecnico=tecnico.idtecnico'); 
	 		  								   $records3->execute();
									        ?>
									  
									        <select name="tecnico_idtecnico" class="form-control" required="">
									          <?php
