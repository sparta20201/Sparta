 ...
 //actualizar datos
	if(isset($_POST['id'])){
	    ...
	    if($nusuarioA!=$nusuarioN){
	      $records1=$conn->prepare("SELECT * FROM tecnico WHERE usuario=:usuario");
	    ...
	    if($claveN1!="" && $claveN2!=""){
	      if($claveN1!=$claveN2){
	        ...
	        $records2=$conn->prepare("UPDATE tecnico SET nombres=:nombres,apellidos=:apellidos,usuario=:usuario,password=:claveN2,cedula=:cedula,imagen=:imagen WHERE idtecnico=:id");
	      ...
	      $records2=$conn->prepare("UPDATE tecnico SET nombres=:nombres,apellidos=:apellidos,usuario=:usuario,cedula=:cedula,telefono=:telefono,fecha_nac=:fecha_nac,direccion=:direccion WHERE idtecnico=:id");
	      $records2->bindParam(":nombres",$nombres);
	      $records2->bindParam(":apellidos",$apellidos);
	      $records2->bindParam(":usuario",$nusuarioF);
	      $records2->bindParam(":id",$id);
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li><a href="vertec.php">Volver</a></li>
					</ul>
							...
							<div class="container-fluid">
								<div class="row">
								    ...
								    <form action="" method="post" enctype="multipart/form-data">
								    	<input name="id" type="hidden" value="<?php echo $results['idtecnico']; ?>" required="">
